 ...
 *
 * SYNTAX: node solr_availability_monitor.js <METRIC_STATE> <HOST> <PORT> <PATH> <CORE> <USERNAME> <PASSWORD>
 * 
 * EXAMPLE: node solr_availability_monitor.js "1,1" "10.10.2.5" "8983" "solr" "new_core" "username" "password"
 *
 * README:
...
function processRequest(request) 
{
  ...
  client.query('*', function(err, response) {
    if (err) {
      console.log('1)'+err);
      return;
    }
